...
INSERT INTO `ages` VALUES (8,'1980-04-08',46),(9,'2005-04-14',21),(10,'2004-05-09',21),(11,'2020-05-08',5),(12,'2014-05-14',11),(19,'1990-05-12',36),(20,'2000-05-08',26),(21,'2000-05-04',26),(22,'2005-04-27',21),(23,'2007-03-26',19),(24,'2007-04-06',19),(29,'2003-01-13',23),(30,'2004-05-13',22),(31,'2003-04-10',23),(32,'1997-04-11',29);
...
INSERT INTO `announcements` VALUES (1,'To all staff member of Bosa Addis Ketema kebele ','Tomorrow we will have short at 10:00 LT, In vice administrator office, please try to attend on time.','Meeting',1,1,'2026-06-10 19:16:01');
...
INSERT INTO `complaints` VALUES (2,'TK-E99D96',10,'shortage of water around saris sefer','shortage of water around saris sefer','medium','open','2026-06-10 19:23:10','2026-06-10 19:23:10');
...
CREATE TABLE `divorce_details` (
  ...
  `divorce_place` varchar(255) DEFAULT 'Ifa Bula Kebele, Jimma',
...
INSERT INTO `economic_youth_registry` VALUES (1,22,'Bachelor Degree','Coding',NULL,NULL,'Student','Web developer ','None',0,'2026-05-27','2026-05-27 20:43:09'),(2,11,'Bachelor Degree','Coding','Web developer ','AI','Unemployed','Web developer','None',3,'2026-05-27','2026-05-27 21:04:29'),(3,32,'Masters / Above','Leadership and administration','Management and Business Administration','International relationship','Unemployed','Governmental','None',4,'2026-06-10','2026-06-10 20:20:05');
...
CREATE TABLE `marriage_details` (
  ...
  `marriage_place` varchar(255) DEFAULT 'Ifa Bula Kebele, Jimma',
  `witness1_name` varchar(100) DEFAULT NULL,
  `witness2_name` varchar(100) DEFAULT NULL,
...
INSERT INTO `notifications` VALUES (1,1,'backup','Backup Successful: backup_kebele_2026_06_10_21_08_52.sql','#',1,'2026-06-10 19:08:54'),(2,1,'announcement','New Announcement: To all staff member of Bosa Addis Ketema kebele ','/Ifa Bula/modules/announcements/',1,'2026-06-10 19:16:02'),(3,6,'announcement','New Announcement: To all staff member of Bosa Addis Ketema kebele ','/Ifa Bula/modules/announcements/',0,'2026-06-10 19:16:02'),(4,3,'announcement','New Announcement: To all staff member of Bosa Addis Ketema kebele ','/Ifa Bula/modules/announcements/',0,'2026-06-10 19:16:02'),(5,5,'announcement','New Announcement: To all staff member of Bosa Addis Ketema kebele ','/Ifa Bula/modules/announcements/',0,'2026-06-10 19:16:02'),(6,7,'announcement','New Announcement: To all staff member of Bosa Addis Ketema kebele ','/Ifa Bula/modules/announcements/',0,'2026-06-10 19:16:02'),(7,4,'announcement','New Announcement: To all staff member of Bosa Addis Ketema kebele ','/Ifa Bula/modules/announcements/',0,'2026-06-10 19:16:02');
...
INSERT INTO `police_id_cards` VALUES (1,1,'POL0001','2026-05-27','2029-05-27','Active',59),(2,2,'POL0002','2026-06-10','2029-06-10','Active',73);
...
INSERT INTO `police_records` VALUES (1,8,'12','Inspector','zone 1','','Active','2026-05-27','2026-05-27 19:21:46'),(2,32,'Pol-234','Commander','5','','Active','2026-06-10','2026-06-10 20:24:06');
...
INSERT INTO `staff_online` VALUES (1,'2026-06-06 17:40:40'),(3,'2026-06-10 19:24:28'),(6,'2026-06-06 11:02:26');
...
INSERT INTO `youth_id_cards` VALUES (1,1,'YOUTH0001','2026-05-27','2031-05-27','Active','2026-05-27 20:43:26'),(2,2,'YOUTH0002','2026-05-27','2031-05-27','Active','2026-05-27 21:04:46'),(3,3,'YOUTH0003','2026-06-10','2031-06-10','Active','2026-06-10 20:20:26');
...
-- Dump completed on 2026-06-11  0:20:43
