        ...
        <div class="cert-header">
            <div class="header-flags">
                ...
                <div class="header-title">
                    ...
                    <div class="cert-main-title">MARRIAGE CERTIFICATE</div>
                    <div class="cert-sub-title">Waraqaa Ragaa Fuudhaa fi Heerumaa</div>
                    <div class="cert-sub-am">የጋብቻ ምስክር ወረቀት</div>
